      ...
      <BrowserRouter>
        <div>
          <Suspense fallback={
            ...
            {/* Fixed Navbar at the top with full width and z-index to stay above other content */}
            <div className="fixed top-0 left-0 w-full z-50">
              <Navbar />
            </div>
            {/* Add padding-top to prevent content from being hidden under the fixed Navbar */}
